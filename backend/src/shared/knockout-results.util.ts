...
export const KNOCKOUT_RESULTS: KnockoutResult[] = [
  ...
  { gameNumber: 74, phase: 'r32', homeTeam: 'Alemanha',            awayTeam: 'Paraguai',             homeScore: 1, awayScore: 1, winner: 'Paraguai',      status: 'DONE' }, // pên 3-4
  { gameNumber: 75, phase: 'r32', homeTeam: 'Holanda',             awayTeam: 'Marrocos',             homeScore: 1, awayScore: 1, winner: 'Marrocos',      status: 'DONE' }, // pên 2-3
  ...
  { gameNumber: 82, phase: 'r32', homeTeam: 'Bélgica',             awayTeam: 'Senegal',              homeScore: 3, awayScore: 2, winner: 'Bélgica',       status: 'DONE' }, // prorrogação
  ...
  { gameNumber: 86, phase: 'r32', homeTeam: 'Argentina',           awayTeam: 'Cabo Verde',           homeScore: 3, awayScore: 2, winner: 'Argentina',     status: 'DONE' }, // prorrogação
  { gameNumber: 87, phase: 'r32', homeTeam: 'Portugal',            awayTeam: 'Croácia',              homeScore: 2, awayScore: 1, winner: 'Portugal',      status: 'DONE' },
  { gameNumber: 88, phase: 'r32', homeTeam: 'Austrália',           awayTeam: 'Egito',                homeScore: 1, awayScore: 1, winner: 'Egito',         status: 'DONE' }, // pên 2-4
  ...
  { gameNumber: 96, phase: 'r16', homeTeam: 'Colômbia',            awayTeam: 'Suíça',                homeScore: 0, awayScore: 0, winner: 'Suíça',         status: 'DONE' }, // pên 3-4
